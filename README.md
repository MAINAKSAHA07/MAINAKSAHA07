...
- **Graduate Research Assistant, ASU Adidas Project**  
  ...
  → FFT-based ball tracking + color pipelines  
  → On-screen overlays, haptics, and frame-by-frame analytics  
  → Optimized performance with modular, scalable architecture  
...
- **Co-Founder, GenieGradz** – Drove innovation in EdTech and startup execution. 
---

## 📚 Education
- **M.S. Robotics & Automation Systems (Aritficial Intelligence)** – Arizona State University *(2024–2025)*  
